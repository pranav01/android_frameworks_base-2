    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.ENABLE_APP_CIRCLE_BAR), false, this);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.WHITELIST_APP_CIRCLE_BAR), false, this);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.APP_CIRCLE_BAR_TRIGGER_WIDTH), false, this);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.APP_CIRCLE_BAR_TRIGGER_TOP), false, this);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.APP_CIRCLE_BAR_TRIGGER_HEIGHT), false, this);
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.APP_CIRCLE_BAR_SHOW_TRIGGER), false, this);
            update();
        }
        ...
        public void update() {
            final ContentResolver resolver = mContext.getContentResolver();
            setAppBarVisibility(Settings.CMREMIX.getIntForUser(
                    resolver, Settings.CMREMIX.ENABLE_APP_CIRCLE_BAR, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1);
            String includedApps = Settings.CMREMIX.getStringForUser(resolver,
                    Settings.CMREMIX.WHITELIST_APP_CIRCLE_BAR,
            ...
            int width = Settings.CMREMIX.getInt(
                    resolver, Settings.CMREMIX.APP_CIRCLE_BAR_TRIGGER_WIDTH, 10);
            if (mTriggerWidth != width)
                setTriggerWidth(width);
            setTopPercentage(Settings.CMREMIX.getInt(
                    resolver, Settings.CMREMIX.APP_CIRCLE_BAR_TRIGGER_TOP, 0) / 100f);
            setBottomPercentage(Settings.CMREMIX.getInt(
                    resolver, Settings.CMREMIX.APP_CIRCLE_BAR_TRIGGER_HEIGHT, 100) / 100f);
            if (Settings.CMREMIX.getInt(
                    resolver, Settings.CMREMIX.APP_CIRCLE_BAR_SHOW_TRIGGER, 0) == 1)
                showTriggerRegion();
            else
                hideTriggerRegion();
        }
