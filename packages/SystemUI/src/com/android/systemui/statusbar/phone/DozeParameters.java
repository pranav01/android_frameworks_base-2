...
public class DozeParameters {
    ...
    public boolean getOverwriteValue() {
        final int values = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.DOZE_OVERWRITE_VALUE, 0,
    ...
    public boolean getPocketMode() {
        final int values = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.DOZE_POCKET_MODE, 0,
                UserHandle.USER_CURRENT);
        return values != 0;
    }
    ...
    public boolean getShakeMode() {
        final int values = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.DOZE_SHAKE_MODE, 0,
                UserHandle.USER_CURRENT);
        return values != 0;
    }
    ...
    public boolean getTimeMode() {
        final int values = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.DOZE_TIME_MODE, 0,
                UserHandle.USER_CURRENT);
        return values != 0;
    }
    ...
    public int getPulseInDuration(int reason) {
        ...
        case DozeLog.PULSE_REASON_SENSOR_PICKUP:
            if (getOverwriteValue()) {
                return Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                        Settings.CMREMIX.DOZE_PULSE_DURATION_IN_PICKUP, R.integer.doze_pulse_duration_in_pickup,
                        UserHandle.USER_CURRENT);
            } else {
        ...
        case DozeLog.PULSE_REASON_INTENT:
            if (getOverwriteValue()) {
                return Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                        Settings.CMREMIX.DOZE_PULSE_DURATION_IN_INTENT, R.integer.doze_pulse_duration_in_intent,
                        UserHandle.USER_CURRENT);
            } else {
        ...
        default:
            if (getOverwriteValue()) {
                return Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                        Settings.CMREMIX.DOZE_PULSE_DURATION_IN, R.integer.doze_pulse_duration_in,
                        UserHandle.USER_CURRENT);
            } else {
    ...
    public int getPulseVisibleDuration() {
        if (getOverwriteValue()) {
            return Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                    Settings.CMREMIX.DOZE_PULSE_DURATION_VISIBLE, R.integer.doze_pulse_duration_visible,
                    UserHandle.USER_CURRENT);
        }
    ...
    public int getPulseOutDuration() {
        if (getOverwriteValue()) {
            return Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                    Settings.CMREMIX.DOZE_PULSE_DURATION_OUT, R.integer.doze_pulse_duration_out,
                    UserHandle.USER_CURRENT);
        }
    ...
    public boolean getPulseOnNotifications() {
        if (getOverwriteValue() || setUsingAccelerometerAsSensorPickUp()) {
            final int values = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                    Settings.CMREMIX.DOZE_PULSE_ON_NOTIFICATIONS, 1,
                    UserHandle.USER_CURRENT);
            return values != 0;
        }
    ...
    public int getShakeAccelerometerThreshold() {
        if (getOverwriteValue()) {
            return Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                    Settings.CMREMIX.DOZE_SHAKE_ACC_THRESHOLD, R.integer.doze_shake_accelerometer_threshold,
                    UserHandle.USER_CURRENT);
        }
