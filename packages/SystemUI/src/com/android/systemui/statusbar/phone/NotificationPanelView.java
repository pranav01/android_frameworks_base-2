    ...
    private class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.QS_SMART_PULLDOWN), false, this, UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            mQsSmartPullDown = Settings.CMREMIX.getIntForUser(resolver,
                    Settings.CMREMIX.QS_SMART_PULLDOWN, 0, UserHandle.USER_CURRENT);
