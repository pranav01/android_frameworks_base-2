...
public class NetworkTextView extends TextView implements Observer {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            Uri uri = Settings.CMREMIX.getUriFor(Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_STATE);
            resolver.registerContentObserver(uri, false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX
                    .getUriFor(Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX
                    .getUriFor(Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE_THRESHOLD), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.CMREMIX
                    .getUriFor(Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_COLOR), false,
                    this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mAutoHide = Settings.CMREMIX.getIntForUser(resolver, Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE, 0,
                UserHandle.USER_CURRENT)==1;

        mAutoHideThreshold = Settings.CMREMIX.getIntForUser(resolver, Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE_THRESHOLD,
                10, UserHandle.USER_CURRENT);

        mState = Settings.CMREMIX.getInt(resolver, Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_STATE, 0);

        int defaultColor = Settings.CMREMIX.getInt(resolver,
                Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_COLOR, 0xFFFFFFFF);

        int mNetworkTrafficColor = Settings.CMREMIX.getInt(resolver,
                Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_COLOR, -2);
