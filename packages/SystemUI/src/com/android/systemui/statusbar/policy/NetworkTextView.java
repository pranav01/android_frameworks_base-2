...
public class NetworkTextView extends TextView implements Observer {
    ...
    public NetworkTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        NetworkTrafficSettings.Observer settingsObserver = new NetworkTrafficSettings.Observer(mContext,
                Sets.newHashSet(Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_STATE,
                Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE,
                Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE_THRESHOLD),
