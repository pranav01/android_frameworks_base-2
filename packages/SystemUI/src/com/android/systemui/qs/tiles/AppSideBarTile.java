...
public class AppSideBarTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleSecondaryClick() {
        ...
        intent.setClassName("com.android.settings",
            "com.android.settings.Settings$AppSideBarSettingsActivity");
 ...
 protected void toggleState() {
         Settings.CMREMIX.putInt(mContext.getContentResolver(),
                        Settings.CMREMIX.APP_SIDEBAR_ENABLED, !appsidebarEnabled() ? 1 : 0);
    }
	...
	if (appsidebarEnabled()) {
        state.icon = ResourceIcon.get(R.drawable.ic_qs_sidebar_on);
        state.label = mContext.getString(R.string.quick_settings_appsidebar_on);
	} else {
        state.icon = ResourceIcon.get(R.drawable.ic_qs_sidebar_off);
    ...
    private boolean appsidebarEnabled() {
        return Settings.CMREMIX.getInt(mContext.getContentResolver(),
                Settings.CMREMIX.APP_SIDEBAR_ENABLED, 0) == 1;
    }
    ...
    private class AppSideBarObserver extends ContentObserver {
        ...
        public void startObserving() {
            mContext.getContentResolver().registerContentObserver(
                    Settings.CMREMIX.getUriFor(Settings.CMREMIX.APP_SIDEBAR_ENABLED),
                    false, this);
        }
