...
public class AppCircleBarTile extends QSTile<QSTile.BooleanState> {
 ...
 protected void toggleState() {
         Settings.CMREMIX.putInt(mContext.getContentResolver(),
                        Settings.CMREMIX.ENABLE_APP_CIRCLE_BAR, !appcirclebarEnabled() ? 1 : 0);
    }
	...
	if (appcirclebarEnabled()) {
        state.iconId = R.drawable.ic_qs_appcirclebar_on;
    ...
    private class AppCircleBarObserver extends ContentObserver {
        ...
        public void startObserving() {
            mContext.getContentResolver().registerContentObserver(
                    Settings.CMREMIX.getUriFor(Settings.CMREMIX.ENABLE_APP_CIRCLE_BAR),
                    false, this);
        }
