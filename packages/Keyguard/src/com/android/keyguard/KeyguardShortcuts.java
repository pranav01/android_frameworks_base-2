...
import com.android.internal.util.cmremix.ActionConfig;
...
public class KeyguardShortcuts extends LinearLayout {
    ...
    private void createShortcuts() {
        ...
        int clickType = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.LOCKSCREEN_SHORTCUTS_LONGPRESS, 1, UserHandle.USER_CURRENT);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            mContext.getContentResolver().registerContentObserver(Settings.CMREMIX.getUriFor(
                    Settings.CMREMIX.LOCKSCREEN_SHORTCUTS),
