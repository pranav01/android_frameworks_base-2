...
public class ViewConfiguration {
    ...
    private ViewConfiguration(Context context) {
        ...
        if (Settings.CMREMIX.getInt(resolver,
            ...
            SCROLL_FRICTION = Settings.CMREMIX.getFloat(resolver,
                          Settings.CMREMIX.CUSTOM_SCROLL_FRICTION, DEFAULT_SCROLL_FRICTION);
            int maximumFlingVelocity = Settings.CMREMIX.getInt(resolver,
                          Settings.CMREMIX.CUSTOM_FLING_VELOCITY, DEFAULT_MAXIMUM_FLING_VELOCITY);
            if (maximumFlingVelocity == 0) {
                MAXIMUM_FLING_VELOCITY = DEFAULT_MAXIMUM_FLING_VELOCITY;
            } else {
                MAXIMUM_FLING_VELOCITY = maximumFlingVelocity;
            }
            int overScrollDistance = Settings.CMREMIX.getInt(resolver,
                          Settings.CMREMIX.CUSTOM_OVERSCROLL_DISTANCE, DEFAULT_OVERSCROLL_DISTANCE);
            if (overScrollDistance > 100) {
                OVERSCROLL_DISTANCE = DEFAULT_OVERSCROLL_DISTANCE;
            } else {
                OVERSCROLL_DISTANCE = overScrollDistance;
            }
            int overFlingDistance = Settings.CMREMIX.getInt(resolver,
                          Settings.CMREMIX.CUSTOM_OVERFLING_DISTANCE, DEFAULT_OVERFLING_DISTANCE);
