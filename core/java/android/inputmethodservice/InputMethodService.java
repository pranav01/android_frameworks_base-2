...
public class InputMethodService extends AbstractInputMethodService {
    ...
    public void updateFullscreenMode() {
        boolean fullScreenOverride = Settings.CMREMIX.getIntForUser(getContentResolver(),
                Settings.CMREMIX.DISABLE_FULLSCREEN_KEYBOARD, 0,
    ...
    public void showWindow(boolean showInput) {
        ...
        int mKeyboardRotationTimeout = Settings.CMREMIX.getIntForUser(getContentResolver(),
                Settings.CMREMIX.KEYBOARD_ROTATION_TIMEOUT, 0, UserHandle.USER_CURRENT_OR_SELF);
