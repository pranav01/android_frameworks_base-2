...
public class AppTransition implements Dump {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.CMREMIX.getUriFor(Settings.CMREMIX.ANIMATION_CONTROLS_DURATION), false, this);
            resolver.registerContentObserver(
                    Settings.CMREMIX.getUriFor(Settings.CMREMIX.ANIMATION_CONTROLS_NO_OVERRIDE), false, this);
            for (int i = 0; i < 10; i++) {
                resolver.registerContentObserver(
                    Settings.CMREMIX.getUriFor(Settings.CMREMIX.ACTIVITY_ANIMATION_CONTROLS[i]), false, this);
            }
        }
         @Override
    ...
    private void updateSettings() {
        ...
        int temp = Settings.CMREMIX.getInt(resolver, Settings.CMREMIX.ANIMATION_CONTROLS_DURATION, 0);
